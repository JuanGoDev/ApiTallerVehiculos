...
{
    //Este controlador nos sirve para crear Usuarios
    [ApiController]
    [Route("api/cuentas")]
    public class CuentasController : ControllerBase
    {
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Registrar(IdentityModels credencialesUsuario)
        {
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Login(IdentityModels credencialesUsuario)
        {
        ...
        private async Task<ActionResult<RespuestaAutenticacion>> ConstruirToken(IdentityModels credencialesUsuario)
        {
            ...
            IdentityUser usuario = await userManager.FindByEmailAsync(credencialesUsuario.Email);
